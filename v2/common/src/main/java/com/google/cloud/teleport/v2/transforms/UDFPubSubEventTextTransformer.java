 ...
 * </ul>
 */
public class UDFPubSubEventTextTransformer {

  /* Logger for class. */
  private static final Logger LOG = LoggerFactory.getLogger(UDFPubSubEventTextTransformer.class);
    ...
    public PCollectionTuple expand(PCollection<FailsafeElement<InputT, String>> input) {
      ...
      PCollectionTuple jsonToTableRowOut =
          udfOut
              ...
              .apply(
                  "JsonToTableRow",
                  FailsafePubSubEventJsonToTableRow.<InputT>newBuilder()
